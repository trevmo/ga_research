...
const int attackType = 2;  // 0 - Constant Damage, 1 - Uniform Damage, 2 - Gaussian Damage
const int damageAmount = 15;  // Constant Damage amount
const double meanDamage = 15;  // mean damage for uniform or Gaussian
const double rangeDamage = 5;  // range of damage for uniform or Gaussian (+/- this amount)
